void UpperLimit_ratio_log()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Jun  6 12:22:30 2023) by ROOT version 6.22/09
   TCanvas *c = new TCanvas("c", "c",0,0,780,840);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   c->SetHighLightColor(2);
   c->Range(-4.714286,-2.654368,31,0.617284);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetLogy();
   c->SetTickx(1);
   c->SetTicky(1);
   c->SetLeftMargin(0.132);
   c->SetRightMargin(0.028);
   c->SetTopMargin(0.052);
   ...
   TH1F *Graph_Graph01 = new TH1F("Graph_Graph01","Graph",202,0,29.37514);
   Graph_Graph01->SetMinimum(0.0045);
   Graph_Graph01->SetMaximum(1.088555);
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",202,0,22.95855);
   Graph_Graph12->SetMinimum(0.0045);
   Graph_Graph12->SetMaximum(1.088555);
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",101,0,17.48125);
   Graph_Graph23->SetMinimum(0.0045);
   Graph_Graph23->SetMaximum(1.088555);
   ...
   TH1F *Graph_Graph34 = new TH1F("Graph_Graph34","Graph",101,0,12.03001);
   Graph_Graph34->SetMinimum(0.0045);
   Graph_Graph34->SetMaximum(1.088555);
   ...
   graph->Draw("l");
   TLatex *   tex = new TLatex(0.972,0.96256,"138 fb^{-1} (13 TeV)");
tex->SetNDC();
   tex->SetTextAlign(31);
   tex->SetTextFont(42);
   tex->SetTextSize(0.04576);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.1656,0.9186,"CMS");
tex->SetNDC();
   tex->SetTextAlign(13);
   tex->SetTextFont(61);
   tex->SetTextSize(0.0624);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.1656,0.8562,"Preliminary");
tex->SetNDC();
   tex->SetTextAlign(13);
   tex->SetTextFont(52);
   ...
   TH1F *hframe__2 = new TH1F("hframe__2","",1000,0,30);
   hframe__2->SetMinimum(0.005);
   hframe__2->SetMaximum(2.8);
   ...
   hframe__2->GetXaxis()->SetTitle("#font[12]{r}");
   hframe__2->GetXaxis()->SetNdivisions(506);
   hframe__2->GetXaxis()->SetLabelFont(42);
   hframe__2->GetXaxis()->SetLabelOffset(0.001);
   hframe__2->GetXaxis()->SetLabelSize(0.05);
   hframe__2->GetXaxis()->SetTitleSize(0.07);
   hframe__2->GetXaxis()->SetTitleOffset(0.75);
   hframe__2->GetXaxis()->SetTitleFont(42);
   hframe__2->GetYaxis()->SetTitle("1 #minus CL");
   hframe__2->GetYaxis()->SetLabelFont(42);
   hframe__2->GetYaxis()->SetLabelOffset(0.015);
   hframe__2->GetYaxis()->SetLabelSize(0.05);
   hframe__2->GetYaxis()->SetTitleSize(0.055);
   hframe__2->GetYaxis()->SetTickLength(0.02);
   ...
   TLegend *leg = new TLegend(0.54,0.68,0.92,0.91,NULL,"brNDC");
   leg->SetBorderSize(0);
   ...
   TLegendEntry *entry=leg->AddEntry("NULL","Upper limits","h");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph2","Median expected","L");
   entry->SetLineColor(1);
